...
**Project Name:** Gmail Spam Detection System  
**Folder Name:** `Gmail-Detection-API-Naive-Bayes-main`  
**Primary Language:** Python  
**User Interface:** Streamlit dashboard  
**Main Script:** `Gmail_predict.py`  
**Dashboard Script:** `streamlit_app.py`

## 2. Purpose

Detect spam email content using a Naive Bayes text classifier, with the original script also supporting Gmail API analysis.

## 3. Scope

The dashboard focuses on local spam text classification and avoids requiring Gmail credentials for basic use.
...
- Students
- Email classification demo users
...
**Required Data Source:** spam.csv, uploaded CSV, or dashboard demo data.
...
**Model or Processing Method:** CountVectorizer with Multinomial Naive Bayes
...
```powershell
cd "E:\visual labs project websites\Gmail-Detection-API-Naive-Bayes-main"
```
