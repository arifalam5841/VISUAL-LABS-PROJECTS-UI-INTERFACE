...
**Project Name:** Electricity Consumption Prediction System  
**Folder Name:** `Electricity-Consumption-Prediction-main`  
**Primary Language:** Python  
**User Interface:** Streamlit dashboard  
**Main Script:** `Electricity-prediction.py`  
**Dashboard Script:** `streamlit_app.py`

## 2. Purpose

Predict electricity consumption using weather, historical consumption, and timestamp-derived features.

## 3. Scope

The system performs time feature engineering, trains a regression model, and provides consumption predictions through a dashboard.
...
**Required Data Source:** smart_meter_data.csv or uploaded CSV with Timestamp and consumption columns.
...
**Target or Output Variable:** `Electricity_Consumed`
...
```powershell
cd "E:\visual labs project websites\Electricity-Consumption-Prediction-main"
```
