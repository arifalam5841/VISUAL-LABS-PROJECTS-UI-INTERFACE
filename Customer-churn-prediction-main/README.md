...
**Folder Name:** `Customer-churn-prediction-main`  
**Primary Language:** Python  
**User Interface:** Streamlit dashboard  
**Main Script:** `Customer-churn-prediction.py`  
**Dashboard Script:** `streamlit_app.py`

## 2. Purpose

Predict whether a customer is likely to churn based on service usage and support behavior.

## 3. Scope

The system trains a binary classifier and provides a dashboard form for churn prediction.
...
**Required Data Source:** Built-in demo dataset or uploaded CSV with churn columns.
...
**Target or Output Variable:** `Churn`
...
```powershell
cd "E:\visual labs project websites\Customer-churn-prediction-main"
```
